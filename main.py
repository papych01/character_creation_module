...
def special(char_name, char_class):
    comment = 'применил специальное умение'
    if char_class == 'warrior':
        return (f'{char_name} {comment} «Выносливость {80 + 25}»')
    if char_class == 'mage':
        return (f'{char_name} {comment} «Атака {5 + 40}»')
    if char_class == 'healer':
        return (f'{char_name} {comment} «Защита {10 + 30}»')
